...
class Command
{
    ...
    private:
        ...
        */
        ...
        bool m_hasRef = false; //Check whether if the reference allele index is provided
        bool m_hasAlt = false; //Check whether if the alternative allele index is provided
