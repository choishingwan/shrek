...
class Linkage
{
	public:
		...
		Eigen::VectorXd solve(size_t start, size_t length, Eigen::VectorXd const *const betaEstimate, Eigen::VectorXd const *const sqrtChiSq, Eigen::MatrixXd *variance, Eigen::VectorXd *effectiveReturnResult, size_t sampleSize,size_t snpStart);
